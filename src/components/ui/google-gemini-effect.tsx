...
export function GoogleGeminiEffectDemo() {
  ...
  return (
    ...
    >
      ...
      {/* SVG Effect y Formulario - sticky y más abajo */}
      <div className={cn("sticky top-0 -mt-[100vh]")}>
        <div className="w-full h-[890px] top-20 md:top-40 flex items-center justify-center absolute">
        ...
        <svg
          ...
          className="absolute top-20 md:top-40 w-full"
        >
          <motion.path
