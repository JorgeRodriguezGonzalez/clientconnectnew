...
import { Send, Calendar, Mail, User } from 'lucide-react';
...
export function GoogleGeminiEffectDemo() {
  ...
  // Transformaciones para el gradiente con opacidad 0.5
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="sticky top-0 h-screen w-full pointer-events-none -mt-[100vh]"
      />

      {/* Contenido con texto y CTAs - sticky */}
      <div className="sticky top-0 h-screen flex items-start justify-center pt-32 md:pt-40 -mt-[100vh]">
      ...
      {/* SVG Effect y Formulario - sticky con margin-top para bajarlo */}
      <div className={cn("sticky top-0 -mt-[100vh]")}>
        <div className="w-full h-screen relative mt-40 md:mt-60">
          {/* Contenedor del formulario */}
          <div className="w-full h-[890px] flex items-center justify-center absolute top-0">
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="w-[90%] max-w-[450px] bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8 z-30"
            >
