...
export const SuperHero = ({
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-black via-[#050505] to-[#15171c] flex flex-col items-center justify-start pt-16 px-0 overflow-hidden relative pb-0">
      ...
      <div className="w-full relative h-[680px] flex justify-center overflow-hidden z-[10] mt-8">
