  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-black via-[#050505] to-[#15171c] flex flex-col items-center justify-start pt-8 px-0 overflow-hidden relative pb-0">
      ...
      <div className="absolute top-0 left-0 w-full h-[70vh] z-0 pointer-events-none overflow-hidden">
        {/* Imagen del equipo - Sin filtros, buena opacidad */}
        <div 
        ...
        {/* Overlay "Semicírculo Negro" suave */}
        <div 
            className="absolute inset-0"
            style={{ 
                // Negro en el centro abajo (donde va el texto) y transparente hacia arriba y lados
                background: 'radial-gradient(ellipse at bottom center, #050505 30%, rgba(5,5,5,0.7) 50%, rgba(5,5,5,0.2) 80%, transparent 100%)'
            }}
        ></div>

         {/* Transición suave al fondo negro inferior */}
      ...
      <div className="max-w-[1296px] w-full mx-auto relative z-[30] px-6 pt-32">
        {/* LAMP REMOVED - Space preserved via pt-32 on container */}
