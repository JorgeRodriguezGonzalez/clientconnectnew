...
const clients = [
  ...
  { name: 'Lifestyle Concepts', tags: ['Google Ads', 'Paid Social', 'Website'], image: '/images/landscaping.jpg', logo: 'Lifestyle\nConcepts' },
        ...
        <div className="max-w-[1296px] w-full mx-auto relative z-[30] px-6 mb-4" style={{ marginTop: '-10px' }}>
          ...
          <div className={`relative text-center mb-8 hero-text-mt ${isMobile ? 'z-20' : 'z-10'}`}>
            <motion.h1
              ...
              className="font-sans font-semibold text-[38px] md:text-[52px] lg:text-[64px] leading-[1.1] tracking-[-2px] text-white mb-6 normal-case"
            >
              We Bring{' '}
              {isMobile ? (
                <motion.span
