            ...
            {isTransparentReporting && (
               <div className="relative w-full h-[160px] mt-2 overflow-hidden">
                <div 
                  ...
                  style={{
                    maskImage: 'linear-gradient(to right, transparent 0%, transparent 20%, black 50%, black 95%, transparent 100%), linear-gradient(to bottom, black 60%, transparent 100%)',
                    WebkitMaskImage: 'linear-gradient(to right, transparent 0%, transparent 20%, black 50%, black 95%, transparent 100%), linear-gradient(to bottom, black 60%, transparent 100%)',
                    maskComposite: 'intersect',
                    WebkitMaskComposite: 'source-in'
                  }}
                >
                  ...
                  >
                    ...
                    <motion.path 
                      ...
                      d="M 489.248 5.489 L 489.248 283.23 L 4.869 279.745 L 3.089 174.764 L 20.839 174.892 C 30 172 40 165 60 160 C 80 155 100 152 120 145 C 135 140 150 138 170 130 C 190 122 210 125 230 122 C 250 119 265 95 290 90 C 315 85 335 95 360 95 C 385 95 420 75 450 50 C 465 38 477 22 489.248 5.489 Z" 
                    ...
                    <motion.path 
                      key={`line-${hoverCount}`}
                      d="M 20.839 174.892 C 30 172 40 165 60 160 C 80 155 100 152 120 145 C 135 140 150 138 170 130 C 190 122 210 125 230 122 C 250 119 265 95 290 90 C 315 85 335 95 360 95 C 385 95 420 75 450 50 C 465 38 477 22 489.248 5.489" 
                      fill="transparent" 
