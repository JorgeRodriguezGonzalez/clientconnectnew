...
export const SkillsShowcaseCard = ({
  ...
  return (
    <motion.div 
      ref={ref}
      className="relative flex h-[280px] w-[326.6px] max-w-full flex-col items-center gap-1.5 overflow-hidden rounded-[28px] bg-white p-1.5 border-[1.77px] border-[#4b5563]"
