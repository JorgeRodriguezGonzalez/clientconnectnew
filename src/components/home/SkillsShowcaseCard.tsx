...
export const SkillsShowcaseCard = ({
  ...
  // @return
  return <div className="relative flex h-[380px] w-[326.6px] max-w-full flex-col items-center gap-1.5 overflow-hidden rounded-[28px] bg-white p-1.5 shadow-[0_24px_32px_0_rgba(0,0,0,0.03)]">
      <div className="relative flex h-[262px] w-[314.6px] items-center justify-center overflow-hidden rounded-[22px] bg-[#f5f5f5]">
        <div className="absolute bottom-[-123px] left-[41.8px] h-[352px] w-[219px] overflow-hidden" style={{
        transform: 'scale(0.9)'
      }}>
          <div className="absolute bottom-[-30px] left-[109.6px] top-[-85px] h-[467px] w-[218.6px]" style={{
          transform: 'translateX(-109.309px)'
        }}>
        ...
        {skills.map((skill, index) => <motion.div key={index} className="absolute flex items-center justify-center overflow-hidden rounded-[826px] bg-white px-2.5 py-1.5 shadow-[0_10px_9px_0_rgba(0,0,0,0.12)]" style={{
        ...skill.position,
        ...(skill.transform && {
