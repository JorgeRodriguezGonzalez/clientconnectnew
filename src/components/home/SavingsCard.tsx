...
export const SavingsCard = ({
  ...
  // @return
  return <motion.div className="relative flex flex-col items-center gap-1.5 w-[326.6px] h-[380px] bg-white rounded-[28px] p-1.5 overflow-hidden" style={{
      ...
      <div className="relative flex flex-col items-center justify-center w-[314.6px] h-[262px] bg-[#F5F5F5] rounded-[22px] overflow-hidden">
        ...
        WebkitMaskImage: 'linear-gradient(rgb(0, 0, 0) 68.3541%, rgba(0, 0, 0, 0) 100%)'
          ...
          imageRendering: 'auto'
            ...
            <motion.path d="M 53.822 170.122 C 29.189 152.204 27.801 174.942 20.839 174.892 L 3.089 174.764 L 4.869 279.745 L 489.248 283.23 L 489.248 5.489 C 450.411 67.986 400.334 97.664 374.382 97.664 C 343.334 97.664 333.834 78.489 306.334 78.489 C 270.376 78.489 256.769 133.668 239.781 135.692 C 211.601 139.05 204.045 106.821 181.936 126.692 C 160.817 145.673 145.501 144.542 128.933 138.472 C 109.017 131.175 97.916 147.548 92.857 156.811 C 86.727 168.036 78.454 188.04 53.822 170.122 Z" fill="url(#chartGradient)" stroke="rgb(123,188,112)" strokeWidth="2.77" strokeMiterlimit="10" initial={{
            pathLength: 0,
            opacity: 0
          }} animate={{
            pathLength: 1,
          ...
          <svg className="absolute top-[49px] left-[-15px] w-[343px] h-[7px]" viewBox="0 0 343 7" fill="none" xmlns="http://www.w3.org/2000/svg">
            <motion.path d="M 2.33 3.5 L 367.931 3.5" fill="transparent" stroke="rgb(138,196,128)" strokeWidth="3" strokeMiterlimit="10" strokeDasharray="9.07,9.07" initial={{
            pathLength: 0
          }} animate={{
            pathLength: 1
          }} transition={{
