              ...
              <FadeInText delay={1.2}>
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      backgroundImage: "linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(237,191,134,0.2) 15%, rgba(237,191,134,0.5) 20%, rgb(237,191,134) 23%, rgb(230,161,117) 25%, rgb(222,131,99) 27%, rgb(163,159,141) 29%, rgb(133,173,162) 31%, rgb(103,188,183) 33%, rgba(103,188,183,0.5) 36%, rgba(103,188,183,0.2) 41%, rgba(255,255,255,0) 46%, rgba(255,255,255,0) 54%, rgba(103,188,183,0.2) 59%, rgba(103,188,183,0.5) 64%, rgb(103,188,183) 67%, rgb(133,173,162) 69%, rgb(163,159,141) 71%, rgb(222,131,99) 73%, rgb(230,161,117) 75%, rgb(237,191,134) 77%, rgba(237,191,134,0.5) 80%, rgba(237,191,134,0.2) 85%, rgba(255,255,255,0) 100%)",
