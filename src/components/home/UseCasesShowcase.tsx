              ...
              <FadeInText delay={1.2}>
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      backgroundImage: "linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(237,191,134,0.2) 3%, rgba(237,191,134,0.5) 5%, rgb(237,191,134) 7%, rgb(230,161,117) 11%, sig(222,131,99) 15%, rgb(163,159,141) 19%, rgb(133,173,162) 23%, rgb(103,188,183) 27%, rgba(103,188,183,0.5) 31%, rgba(103,188,183,0.2) 33%, rgba(255,255,255,0) 35%, rgba(255,255,255,0) 65%, rgba(103,188,183,0.2) 67%, rgba(103,188,183,0.5) 69%, rgb(103,188,183) 73%, rgb(133,173,162) 77%, rgb(163,159,141) 81%, rgb(222,131,99) 85%, rgb(230,161,117) 89%, rgb(237,191,134) 93%, rgba(237,191,134,0.5) 95%, rgba(237,191,134,0.2) 97%, rgba(255,255,255,0) 100%)",
