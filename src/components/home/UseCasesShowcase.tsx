...
export const UseCasesShowcase = (props: UseCasesShowcaseProps) => {
  ...
  React.useEffect(() => {
    if (isInView) {
      ctrl1.start({ opacity: 1, x: 0, transition: { delay: 0.6, duration: 0.8 } });
      ctrl2.start({ opacity: 1, scale: 1, transition: { delay: 0.7, duration: 0.8 } });
      ctrl3.start({ opacity: 1, x: 0, transition: { delay: 0.8, duration: 0.8 } });
      ctrl4.start({ opacity: 1, scale: 1, rotate: 0, transition: { delay: 0.9, duration: 1.0 } });
      ctrl5.start({ opacity: 1, y: 0, transition: { delay: 1.0, duration: 0.8 } });
    }
  }, [isInView]);
  ...
  return (
    <section ref={ref} className="relative bg-white -mt-24">
