        ...
        <div className="relative flex flex-col lg:flex-row items-stretch">
          ...
          <div className="hidden lg:block absolute left-[50%] top-0 bottom-0 w-[1px] bg-zinc-200 z-10 overflow-visible">
             ...
             <motion.div 
               ...
               className="absolute left-0 w-[1.5px] -ml-[0.5px] h-[200px] -translate-y-full blur-[0.5px]"
             />
             ...
             <motion.div 
               ...
               className="absolute left-0 bottom-0 h-[1.5px] -ml-[0.5px] rounded-r-full blur-[0.5px] origin-left z-20"
             />
