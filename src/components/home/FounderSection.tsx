...
const SemrushLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M340.8 154.4C340.8 154.4 288 76.8 144 76.8C144 76.8 48 76.8 16 160C16 160 0 198.4 0 240C0 240 76.8 108.8 220.8 140.8L172.8 176C172.8 176 67.2 176 48 284.8C48 284.8 144 169.6 233.6 201.6L185.6 236.8C185.6 236.8 112 236.8 96 326.4C96 326.4 160 265.6 243.2 286.4C243.2 286.4 206.4 310.4 204.8 313.6C204.8 313.6 163.2 316.8 147.2 368C147.2 368 192 339.2 224 345.6C224 345.6 195.2 374.4 195.2 412.8C195.2 412.8 211.2 380.8 243.2 374.4C243.2 374.4 252.8 430.4 284.8 454.4C284.8 454.4 272 409.6 284.8 380.8C284.8 380.8 320 425.6 368 435.2C368 435.2 326.4 393.6 326.4 355.2C326.4 355.2 377.6 393.6 416 393.6C416 393.6 358.4 361.6 345.6 326.4C345.6 326.4 406.4 345.6 448 332.8C448 332.8 384 316.8 355.2 284.8C355.2 284.8 425.6 291.2 464 268.8C464 268.8 390.4 272 355.2 243.2C355.2 243.2 432 230.4 470.4 198.4C470.4 198.4 396.8 220.8 345.6 201.6C345.6 201.6 432 163.2 480 102.4C480 102.4 384 163.2 340.8 154.4Z" fill="#FF642D"/>
    <circle cx="352" cy="224" r="80" fill="white"/>
    <circle cx="368" cy="208" r="24" fill="#FF642D"/>
  </svg>
);
...
function AnimatedLogos({ isLightMode }: { isLightMode: boolean }) {
  const icons = [
    ...
    { icon: <SemrushLogo className="h-6 w-6" />, size: "lg" as const },
