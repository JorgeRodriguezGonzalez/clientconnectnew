...
const SemrushLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="#FF642D"/>
    <path d="M16.5 8.5c-.2-1.1-1.2-1.8-2.8-1.8-1.4 0-2.5.6-2.5 1.7 0 1 .8 1.4 2.2 1.7l1.4.3c2.1.5 3.2 1.4 3.2 3.1 0 2.1-1.8 3.3-4.2 3.3-2.5 0-4.1-1.2-4.3-3.1h2.1c.2 1.1 1.1 1.6 2.3 1.6 1.5 0 2.4-.6 2.4-1.7 0-.9-.7-1.3-2.1-1.6l-1.5-.3c-1.9-.4-3.1-1.3-3.1-3.1 0-2 1.7-3.2 4.1-3.2 2.3 0 3.9 1.2 4.1 3h-2.3z" fill="white"/>
  </svg>
);
