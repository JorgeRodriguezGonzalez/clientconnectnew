...
const fontStyles = `
  ...
  /* FIX: Prevenir interferencias de transiciones globales */
  .framer-fix * {
...
const TiltCard = ({ 
  ...
  return (
    <motion.div
      layout={props.layout} // Asegurar que layout se pasa
      layoutId={layoutId}
      onMouseMove={handleMouseMove}
      onMouseLeave={handleMouseLeave}
      initial={initial || { opacity: 0, scale: 0.9 }}
      animate={animate || { opacity: 1, scale: 1 }}
      // UPDATE: Usar spring por defecto para layout para mayor suavidad
      ...
      // UPDATE: will-change-transform para forzar GPU
      className={cn("relative rounded-3xl overflow-hidden transition-colors duration-300 will-change-transform", className)}
      {...props} 
    >
      {children}
    </motion.div>
            ...
            >
              ...
              */}
              <TiltCard 
                ...
                layout
                // OPTIMIZATION: Spring transition handles layout changes much smoother than linear/ease
                transition={{ 
                  layout: { type: "spring", stiffness: 300, damping: 30 },
                  opacity: { duration: 0.5 }
                }}
                ...
                className={cn(
                   ...
                   // OPTIMIZATION: will-change helps browser optimization
              ...
              >
                ...
                <div className="absolute inset-0 bg-gray-900 overflow-hidden rounded-3xl">
                  {/* OPTIMIZATION: layout="position" prevents image squashing */}
                  <motion.img 
                    layout="position"
                  ...
                  {/* OPTIMIZATION: layout on the text container prevents jumping */}
                 ...
                 {isLightMode && (
                    <>
                       ...
                       <TiltCard 
                        ...
                        className="h-[280px] p-6 flex flex-col justify-between bg-gray-100 border border-gray-200 relative overflow-hidden group will-change-transform"
                       >
                       ...
                       <TiltCard 
                        ...
                        animate={{ opacity: 1, scale: 1 }}
                        exit={{ opacity: 0, scale: 0.8, transition: { duration: 0.2 } }}
                        className="h-[300px] bg-black relative group border border-white/10 cursor-pointer will-change-transform"
                       >
              ...
              <TiltCard 
                layout
                className={cn(
                "md:col-span-2 p-8 flex flex-col md:flex-row items-center gap-8 transition-colors duration-0 border will-change-transform",
                isLightMode 
              ...
              {/* TARJETAS INFERIORES */}
               ...
               <TiltCard 
                  ...
                  className="h-[280px] relative rounded-3xl group bg-zinc-100/50 p-0 border-none overflow-hidden will-change-transform"
               >
                   <GlowingEffect spread={40} glow={true} disabled={false} proximity={64} inactiveZone={0.01} borderWidth={1.5} />
               ...
               <TiltCard 
                  ...
                  style={{ pointerEvents: isLateScroll ? 'auto' : 'none' }}
                  className="h-[280px] relative rounded-3xl group bg-gray-900 border-none overflow-hidden will-change-transform"
               >
