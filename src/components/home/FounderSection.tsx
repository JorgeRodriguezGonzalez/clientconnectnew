  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.line x1="80" y1="152" x2="490" y2="152" stroke={COLORS.cyan} strokeWidth="2" strokeDasharray="5,5" strokeOpacity="0.3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, ease: 'easeInOut', delay: 0.5 }} />
        
        <g clipPath="url(#clipBelowLine)">
          <motion.path d="M 489.248 283.23 L 4.869 279.745 L 80 240 C 160 195 230 165 280 155 C 300 152 310 151.5 320 152 C 330 152.5 340 152 350 152 C 370 148 400 130 440 95 C 470 65 485 35 489.248 5.489 L 489.248 283.23 Z" fill="url(#chartGradientTeal)" stroke={COLORS.cyan} strokeWidth="2" strokeMiterlimit="10" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ duration: 1.5, ease: 'easeInOut', delay: 0 }} />
        </g>
        
        <g clipPath="url(#clipAboveLine)">
          <motion.path d="M 489.248 5.489 L 489.248 283.23 L 4.869 279.745 L 80 240 C 160 195 230 165 280 155 C 300 152 310 151.5 320 152 C 330 152.5 340 152 350 152 C 370 148 400 130 440 95 C 470 65 485 35 489.248 5.489 Z" fill="url(#chartGradientEmerald)" stroke={COLORS.emerald} strokeWidth="2" strokeMiterlimit="10" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ duration: 1.5, ease: 'easeInOut', delay: 0 }} />
        </g>
        
        <g clipPath="url(#clipBelowLine)">
          <motion.path d="M 80 240 C 160 195 230 165 280 155 C 300 152 310 151.5 320 152 C 330 152.5 340 152 350 152 C 370 148 400 130 440 95 C 470 65 485 35 489.248 5.489" fill="transparent" stroke={COLORS.cyan} strokeOpacity="0.5" strokeWidth="2" strokeMiterlimit="10" strokeDasharray="9.07,9.07" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1, ease: 'easeInOut', delay: 0.1 }} />
        </g>
        
        <g clipPath="url(#clipAboveLine)">
          <motion.path d="M 80 240 C 160 195 230 165 280 155 C 300 152 310 151.5 320 152 C 330 152.5 340 152 350 152 C 370 148 400 130 440 95 C 470 65 485 35 489.248 5.489" fill="transparent" stroke={COLORS.emerald} strokeOpacity="0.5" strokeWidth="2" strokeMiterlimit="10" strokeDasharray="9.07,9.07" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1, ease: 'easeInOut', delay: 0.1 }} />
        </g>
      </svg>
    </div>
  );
...
export const FounderSection = () => {
  ...
  return (
    <section 
      ref={containerRef} 
      className={cn(
        "relative w-full py-24 lg:pt-32 lg:pb-16 transition-colors duration-0 z-10 font-sans", 
          ...
          <div className="lg:w-[40%] sticky top-32">
            <div className="flex flex-col gap-6 pb-10">
              ...
              <p className={cn(
                ...
                We combine powerful data with deep empathy, ensuring you never face your growth journey alone.
              </p>

              <div className="flex flex-col gap-3 mt-2">
                {["Dedicated Success Managers", "Transparent Communication", "Proactive Strategy Sessions"].map((item, i) => (
          ...
          <div className="lg:w-[60%] relative pt-0 lg:pt-0">
            <motion.div layout className="grid grid-cols-1 md:grid-cols-2 gap-5 auto-rows-[minmax(200px,auto)]">
              ...
              <TiltCard 
                ...
                innerClassName={cn("border", isLightMode ? "bg-white border-zinc-200" : "bg-zinc-900 border-white/10")}
              >
                <motion.div 
                  initial={{ opacity: 0 }}
                    ...
                    <>
                       ...
                       >
                          ...
                          <div className="relative z-10 p-6 flex flex-col items-start">
                             <div className="flex justify-between items-center w-full mb-2">
                                ...
                                <span className="font-sans text-[10px] font-bold uppercase tracking-wider text-gray-400">Partnership</span>
                             </div>
                             <div>
                                <h3 className="text-3xl font-sans font-bold text-gray-900 leading-tight">
                                  Shared <span className="text-gray-400">Victories</span>
                                </h3>
                                <p className="font-sans text-xs text-gray-500 font-medium mt-1">We celebrate every win with you.</p>
                             </div>
                          </div>
                       ...
                       >
                          <div className="absolute inset-0 w-full h-full">
                             <video autoPlay loop muted playsInline className={cn("w-full h-full object-cover transition-all duration-700 ease-out", isCaseStudyActive ? "grayscale-0" : "grayscale opacity-60 group-hover:opacity-80")}>
                                <source src="https://videos.pexels.com/video-files/3196071/3196071-uhd_2560_1440_25fps.mp4" type="video/mp4" />
                             </video>
                          </div>
                          <motion.div className="absolute inset-0 z-20 pointer-events-none" animate={{ opacity: isCaseStudyActive ? 0 : 1 }} transition={{ duration: 0.5 }}>
                             ...
                             <div className="absolute bottom-5 left-5">
                                <span className="px-3 py-1 bg-black/50 backdrop-blur border border-white/10 rounded-none text-white text-[11px] font-sans font-medium">Hear our Stories</span>
                             </div>
                          </motion.div>
                       </TiltCard>
                    </>
              ...
              <TiltCard 
                ...
                transition={{ duration: isLightMode ? 0.5 : 0, delay: isLightMode ? 0.5 : 0, ease: "easeOut" }}
                className="md:col-span-2 group safari-gpu h-[240px]"
                innerClassName={cn("p-8 transition-colors duration-0 border relative", isLightMode ? "bg-white border-zinc-200" : "bg-zinc-900 border-zinc-800")}
              >
                 <div className={cn("absolute top-6 right-6 rounded-full border px-2 py-0.5 text-[10px] uppercase tracking-wider font-medium z-20", isLightMode ? "border-zinc-200 text-gray-500" : "border-white/20 text-white/60")}>
                    Expertise
                 </div>
                 <div className="grid grid-cols-12 gap-4 h-full items-center">
                    <div className="col-span-5 flex flex-col justify-center h-full">
                        <h3 className={cn("font-sans font-bold text-xl mb-2", isLightMode ? "text-gray-900" : "text-white")}>Expert Hands</h3>
                        <p className={cn("font-sans font-medium text-xs leading-relaxed", isLightMode ? "text-gray-500" : "text-white/70")}>
                          We master the complex ecosystem of digital tools so you can focus on your business.
                        </p>
                    </div>
              ...
              {/* CARD 5: ALWAYS CLOSE — imagen color estático, hover blanco y negro */}
              <TiltCard 
                  layout
                   ...
                   <div className="absolute right-0 top-0 w-[55%] h-full overflow-hidden">
                      <div className="relative w-full h-full transition-transform duration-500 ease-out group-hover:scale-105 origin-center">
                          ...
                          <img 
                             ...
                             // ✅ CAMBIO: color estático, grayscale en hover
