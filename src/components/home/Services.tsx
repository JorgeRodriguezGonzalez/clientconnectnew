    ...
    >
      {!isMobile && service.videoUrl && (
        <video
          ...
          playsInline
          preload="metadata"
          poster={service.posterUrl || service.imageUrl}
