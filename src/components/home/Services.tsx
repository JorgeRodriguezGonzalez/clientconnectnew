...
const SERVICES = [
  ...
  { id: "email-marketing", title: "Email Marketing", description: "Nurture leads and retain customers with personalized automated email flows.", capabilityCount: 4, tags: ["Automation Flows", "Newsletter", "List Segmentation", "A/B Testing"], imageUrl: PANORAMIC_IMAGES.data, bgSize: "300% 100%", bgPosition: "0% 50%" },  { id: "cro", title: "CRO", description: "Maximize the value of every visitor by optimizing your conversion funnels.", capabilityCount: 4, tags: ["User Testing", "Heatmaps", "Funnel Analysis", "UX Optimization"], imageUrl: PANORAMIC_IMAGES.data, bgSize: "300% 100%", bgPosition: "50% 50%" },
];
