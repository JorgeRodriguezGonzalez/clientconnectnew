...
export function NewHero() {
  ...
  return (
    <motion.div
      ...
      className="h-[2000vh] w-full dark:border dark:border-white/[0.1] rounded-md relative overflow-clip"
    >
      <div className="top-[-40px] h-[150vh] flex justify-center pt-32">
        <div className="z-10 flex flex-col items-center justify-center gap-4 w-full px-5 relative">
          ...
          >
            ...
            {/* Sparkles Effect */}
            <motion.div 
              className="relative  -mt-[1850px] h-[2450px] w-full overflow-hidden"
              style={{
