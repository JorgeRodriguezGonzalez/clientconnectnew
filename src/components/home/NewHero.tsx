...
export function NewHero() {
  ...
  // Anchos aproximados para cada palabra (en px) - aumentados para evitar cortes
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex justify-center pt-32">
        ...
        <div className="z-10 flex flex-col items-center justify-center gap-4 max-w-[976px] px-5 relative">
          ...
          {/* Lamp Effect */}
          <div className="w-full h-[80px] relative flex items-center justify-center pt-80">
            <motion.div
          ...
          >
            <div className="mx-auto w-full max-w-2xl">
              <div className="text-center text-2xl md:text-2xl">
