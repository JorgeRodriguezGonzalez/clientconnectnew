        ...
        <div className="z-10 flex flex-col items-center justify-center gap-4 max-w-[976px] px-5 relative">
          ...
          >
            ...
            <div className="relative -mt-32 h-96 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)]">
              ...
              {/* Arco con transición de color - AUMENTADO TAMAÑO */}
              <motion.div 
                className="absolute left-1/2 top-1/2 aspect-[1/0.7] z-10 w-[300%] rounded-[100%] border-t border-white/20 -translate-x-1/2" 
