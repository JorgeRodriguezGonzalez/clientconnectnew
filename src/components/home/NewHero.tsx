      ...
      <div className="top-[-40px] h-[150vh] flex justify-center pt-32">
        <div className="z-10 flex flex-col items-center justify-center gap-4 w-full px-5 relative">
          ...
          >
            ...
            {/* Sparkles Effect */}
            <motion.div 
              className="relative  -mt-[800px] h-[1620px] w-full overflow-hidden"
              style={{
            ...
            >
              ...
              <motion.div 
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 3.4, duration: 0.8, ease: "easeOut" }}
                className="absolute left-1/2 top-[54%] w-[2000vw] h-[2000vw] max-w-[2000px] max-h-[2000px] z-[5] border border-white/20 -translate-x-1/2 flex items-center justify-center" 
