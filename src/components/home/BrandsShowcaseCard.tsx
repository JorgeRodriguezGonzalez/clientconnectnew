    ...
    boxShadow: 'rgba(0, 0, 0, 0.08) 0px 24px 32px 0px'
      ...
      <div className="relative flex flex-col items-center justify-center w-[314.6px] h-[262px] bg-[#F5F5F5] rounded-[22px] overflow-hidden">
        <div className="relative w-full h-full">
          <motion.div className="absolute w-[146px] h-[249px] overflow-visible" style={{
          top: '90.6px',
          left: '5.6px',
          ...
          <motion.div className="absolute w-[146px] h-[248px] overflow-visible" style={{
          top: '92px',
          left: '164.8px',
          ...
          <motion.div className="absolute w-[156px] h-[287px] overflow-visible rounded-[9px]" style={{
          top: '48.6px',
          left: '79.4px',
