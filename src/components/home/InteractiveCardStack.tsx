        ...
        <g clipPath={`url(#${idPrefix}clip0)`}>
          ...
          <g clipPath={`url(#${idPrefix}clip1)`}>
            ...
            <g clipPath={`url(#${idPrefix}clip2)`}>
              <rect width="308" height="20" transform="matrix(0.865865 0.500278 -0.871576 0.490261 116.703 59.6813)" fill="#cffafe" />
              
              <path d="M367.747 214.667C365.34 216.021 361.451 215.999 359.06 214.617C356.669 213.236 356.682 211.018 359.088 209.664C361.495 208.311 365.384 208.333 367.775 209.715C370.167 211.096 370.154 213.313 367.747 214.667ZM360.82 210.665C359.376 211.477 359.368 212.808 360.803 213.637C362.238 214.465 364.571 214.479 366.015 213.667C367.459 212.854 367.467 211.524 366.032 210.695C364.598 209.866 362.264 209.853 360.82 210.665Z" fill="#06b6d4" />
              <path d="M366.904 210.205C367.385 209.934 368.176 209.936 368.549 210.26C368.906 210.572 369.177 210.914 369.348 211.276C369.626 211.864 369.631 212.483 369.362 213.071C369.094 213.659 368.56 214.196 367.815 214.628C367.357 214.894 366.829 215.115 366.251 215.284C365.649 215.46 364.96 215.237 364.773 214.864C364.586 214.492 364.982 214.113 365.537 213.893C365.723 213.819 365.896 213.736 366.056 213.643C366.503 213.384 366.823 213.062 366.984 212.709C367.146 212.356 367.143 211.985 366.976 211.632C366.916 211.506 366.837 211.384 366.738 211.267C366.444 210.917 366.423 210.476 366.904 210.205Z" fill="#0e7490" />
              
              <rect x="-0.00285524" y="0.495269" width="23" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 335.723 193.684)" fill="#cffafe" />
              <rect x="-0.00285524" y="0.495269" width="23" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 335.723 193.684)" stroke="#0e7490" />
              <rect x="-0.00285524" y="0.495269" width="15" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 316.673 182.678)" fill="#cffafe" />
              <rect x="-0.00285524" y="0.495269" width="15" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 316.673 182.678)" stroke="#0e7490" />
            </g>
            ...
            <g clipPath={`url(#${idPrefix}clip3)`}>
              ...
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 198 56.9032)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 198.017 53.9316)" stroke="#0e7490" />
            
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 223.909 74.415)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 265.47 98.4283)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 307.032 122.442)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 348.593 146.455)" fill="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip4)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.148 77.691)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.562 80.9165)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.562 80.9165)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.579 77.9449)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip5)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 280.709 101.704)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.123 104.93)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.123 104.93)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.141 101.958)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip6)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.271 125.718)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.685 128.943)" fill="#cffafe" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.685 128.943)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.702 125.972)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip7)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 363.832 149.731)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.246 152.956)" fill="#cffafe" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.246 152.956)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.264 149.985)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip8)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.23 89.4573)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.644 92.6827)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.644 92.6827)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.661 89.7112)" stroke="#0e7490" />
            <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 243.841 92.329)" fill="#0e7490" />
            
            <path d="M386.91 168.606C385.525 169.385 383.286 169.372 381.91 168.577C380.534 167.782 380.541 166.506 381.926 165.727C383.312 164.948 385.55 164.96 386.926 165.756C388.303 166.551 388.295 167.827 386.91 168.606ZM382.923 166.303C382.092 166.77 382.088 167.536 382.913 168.013C383.739 168.49 385.082 168.498 385.913 168.03C386.744 167.563 386.749 166.797 385.923 166.32C385.097 165.843 383.754 165.835 382.923 166.303Z" fill="#06b6d4" />
            <path d="M386.425 166.038C386.702 165.882 387.157 165.883 387.371 166.07C387.521 166.2 387.645 166.341 387.739 166.488C387.914 166.762 387.984 167.055 387.942 167.345C387.9 167.635 387.748 167.916 387.497 168.169C387.246 168.422 386.901 168.64 386.487 168.809C386.072 168.978 385.598 169.093 385.096 169.147C384.595 169.201 384.078 169.193 383.581 169.122C383.085 169.051 382.62 168.919 382.22 168.737C382.005 168.639 381.811 168.527 381.642 168.404C381.401 168.228 381.545 167.983 381.894 167.884C382.242 167.785 382.662 167.873 382.942 168.029C382.992 168.057 383.045 168.084 383.099 168.109C383.34 168.218 383.618 168.297 383.916 168.34C384.214 168.382 384.524 168.387 384.825 168.355C385.126 168.323 385.411 168.253 385.659 168.152C385.908 168.051 386.115 167.92 386.266 167.768C386.416 167.616 386.507 167.448 386.532 167.274C386.557 167.099 386.516 166.924 386.411 166.759C386.387 166.722 386.36 166.685 386.329 166.649C386.16 166.448 386.148 166.194 386.425 166.038Z" fill="#0e7490" />
            <path d="M344.91 144.606C343.525 145.385 341.286 145.372 339.91 144.577C338.534 143.782 338.541 142.506 339.926 141.727C341.312 140.948 343.55 140.96 344.926 141.756C346.303 142.551 346.295 143.827 344.91 144.606ZM340.923 142.303C340.092 142.77 340.088 143.536 340.913 144.013C341.739 144.49 343.082 144.498 343.913 144.03C344.744 143.563 344.749 142.797 343.923 142.32C343.097 141.843 341.754 141.835 340.923 142.303Z" fill="#06b6d4" />
          ...
          <rect x="-0.00285524" y="0.495269" width="307" height="94" rx="9.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.4734 76.6819)" stroke="#0e7490" />
          
          <g clipPath={`url(#${idPrefix}clip9)`}>
            <rect width="308" height="95" rx="10" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.042 72.4279)" fill="#cffafe" />
            
            <g clipPath={`url(#${idPrefix}clip10)`}>
              <rect width="308" height="20" transform="matrix(0.865865 0.500278 -0.871576 0.490261 28.6738 109.197)" fill="#cffafe" />
              
              <circle cx="5" cy="5" r="5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 275.417 256.729)" fill="#06b6d4" />
              <g clipPath={`url(#${idPrefix}clip11)`}>
                <path d="M273.244 260.537L272.903 262.234L279.193 261.893" stroke="#ecfeff" strokeLinecap="round" strokeLinejoin="round" />
              </g>
              <rect x="-0.00285524" y="0.495269" width="19" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 251.157 245.202)" fill="#cffafe" />
              <rect x="-0.00285524" y="0.495269" width="19" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 251.157 245.202)" stroke="#0e7490" />
            </g>
            ...
            <g clipPath={`url(#${idPrefix}clip12)`}>
              ...
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.971 106.419)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.988 103.448)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip13)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.118 127.207)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.533 130.433)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.533 130.433)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.55 127.461)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip14)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 192.68 151.22)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.094 154.446)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.094 154.446)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.111 151.474)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip15)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.241 175.234)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.656 178.459)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.656 178.459)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.673 175.488)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip16)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 254.885 211.013)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.299 214.239)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.299 214.239)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.316 211.267)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip17)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.324 187)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.738 190.226)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.738 190.226)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.755 187.254)" stroke="#0e7490" />
            
            <g clipPath={`url(#${idPrefix}clip18)`}>
              <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.201 138.973)" fill="#ecfeff" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.615 142.199)" fill="#06b6d4" />
              <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.615 142.199)" stroke="#0e7490" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.632 139.227)" stroke="#0e7490" />
            
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 135.879 123.931)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 177.441 147.944)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 219.002 171.958)" fill="#0e7490" />
            <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.646 207.737)" fill="#0e7490" />
            <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 238.935 189.872)" fill="#0e7490" />
            <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 155.812 141.845)" fill="#0e7490" />
          </g>
