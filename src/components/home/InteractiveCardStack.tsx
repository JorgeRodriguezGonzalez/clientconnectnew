...
// --- Matriz de Transformación 3D (Isométrica) ---
...
/**
 * CAPA SUPERIOR (NodeCardLayer)
 * Restaurado con TODOS los detalles originales del Componente 1:
 * - Nodos de la izquierda (lista vertical)
 * - Nodos de la derecha (conectados)
 * - Líneas de conexión
 * - Iconos y Checkmarks
 */
const NodeCardLayer = ({ idPrefix }: { idPrefix: string }) => (
  <svg width="460" height="300" viewBox="0 0 460 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="pointer-events-none align-middle">
    <defs>
      {/* Definición de todos los ClipPaths originales para mantener los recortes exactos */}
      ...
      <g clipPath={`url(#${idPrefix}clip0)`}>
        ...
        <g clipPath={`url(#${idPrefix}clip1)`}>
          ...
          <g clipPath={`url(#${idPrefix}clip2)`}>
            ...
            <path d="M366.904 210.205C367.385 209.934 368.176 209.936 368.549 210.26C368.906 210.572 369.177 210.914 369.348 211.276C369.626 211.864 369.631 212.483 369.362 213.071C369.094 213.659 368.56 214.196 367.815 214.628C367.357 214.894 366.829 215.115 366.251 215.284C365.649 215.46 364.96 215.237 364.773 214.864C364.586 214.492 364.982 214.113 365.537 213.893C365.723 213.819 365.896 213.736 366.056 213.643C366.503 213.384 366.823 213.062 366.984 212.709C367.146 212.356 367.143 211.985 366.976 211.632C366.916 211.506 366.837 211.384 366.738 211.267C366.444 210.917 366.423 210.476 366.904 210.205Z" fill="#3b82f6" />
            <rect x="-0.00285524" y="0.495269" width="23" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 335.723 193.684)" fill="#bfdbfe" />
            <rect x="-0.00285524" y="0.495269" width="23" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 335.723 193.684)" stroke="#3b82f6" />
            <rect x="-0.00285524" y="0.495269" width="15" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 316.673 182.678)" fill="#bfdbfe" />
            <rect x="-0.00285524" y="0.495269" width="15" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 316.673 182.678)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="307" height="19" transform="matrix(0.865865 0.500278 -0.871576 0.490261 117.134 59.9352)" stroke="#3b82f6" />
          ...
          <g clipPath={`url(#${idPrefix}clip3)`}>
            ...
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 198 56.9032)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 198 56.9032)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 198.017 53.9316)" stroke="#3b82f6" />
          ...
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 307.032 122.442)" fill="#3b82f6" />
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 348.593 146.455)" fill="#3b82f6" />
          ...
          <g clipPath={`url(#${idPrefix}clip4)`}>
            ...
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.562 80.9165)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.562 80.9165)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.579 77.9449)" stroke="#3b82f6" />
          
          {/* Nodo 3 */}
          <g clipPath={`url(#${idPrefix}clip5)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 280.709 101.704)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.123 104.93)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.123 104.93)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 281.141 101.958)" stroke="#3b82f6" />
          
          {/* Nodo 4 */}
          <g clipPath={`url(#${idPrefix}clip6)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.271 125.718)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.685 128.943)" fill="#bfdbfe" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.685 128.943)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 322.702 125.972)" stroke="#3b82f6" />
          
          {/* Nodo 5 */}
          <g clipPath={`url(#${idPrefix}clip7)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 363.832 149.731)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.246 152.956)" fill="#bfdbfe" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.246 152.956)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 364.264 149.985)" stroke="#3b82f6" />
          
          {/* Nodo 6 */}
          <g clipPath={`url(#${idPrefix}clip8)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.23 89.4573)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.644 92.6827)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.644 92.6827)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 218.661 89.7112)" stroke="#3b82f6" />
          <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 243.841 92.329)" fill="#3b82f6" />
          ...
          <path d="M344.91 144.606C343.525 145.385 341.286 145.372 339.91 144.577C338.534 143.782 338.541 142.506 339.926 141.727C341.312 140.948 343.55 140.96 344.926 141.756C346.303 142.551 346.295 143.827 344.91 144.606ZM340.923 142.303C340.092 142.77 340.088 143.536 340.913 144.013C341.739 144.49 343.082 144.498 343.913 144.03C344.744 143.563 344.749 142.797 343.923 142.32C343.097 141.843 341.754 141.835 340.923 142.303Z" fill="#60a5fa" />
          <path d="M344.425 142.038C344.702 141.882 345.157 141.883 345.371 142.07C345.608 142.275 345.778 142.505 345.871 142.747C346.015 143.121 345.97 143.51 345.741 143.868C345.511 144.227 345.107 144.54 344.576 144.772C344.044 145.003 343.407 145.143 342.739 145.175C342.071 145.207 341.399 145.13 340.803 144.953C340.206 144.776 339.709 144.506 339.369 144.175C339.029 143.844 338.861 143.465 338.885 143.083C338.9 142.836 338.994 142.594 339.162 142.369C339.314 142.164 339.762 142.12 340.084 142.247C340.406 142.374 340.475 142.625 340.372 142.84C340.329 142.929 340.304 143.022 340.298 143.116C340.284 143.346 340.385 143.573 340.589 143.772C340.792 143.97 341.091 144.132 341.449 144.239C341.807 144.345 342.21 144.391 342.611 144.372C343.012 144.352 343.394 144.268 343.713 144.13C344.032 143.991 344.274 143.803 344.412 143.588C344.549 143.373 344.576 143.139 344.49 142.915C344.454 142.823 344.4 142.733 344.329 142.649C344.16 142.448 344.148 142.194 344.425 142.038Z" fill="#3b82f6" />
        </g>
        
        {/* Fondo del Stack Izquierdo */}
        <rect x="-0.00285524" y="0.495269" width="307" height="94" rx="9.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 182.503 23.1656)" stroke="#3b82f6" />
        
        {/* Stack de Tarjetas Izquierdo (Visualmente debajo del panel derecho) */}
        <rect x="-0.00285524" y="0.495269" width="307" height="94" rx="9.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.4734 76.6819)" fill="#93c5fd" />
        <rect x="-0.00285524" y="0.495269" width="307" height="94" rx="9.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.4734 76.6819)" stroke="#3b82f6" />
        
        <g clipPath={`url(#${idPrefix}clip9)`}>
          <rect width="308" height="95" rx="10" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.042 72.4279)" fill="#bfdbfe" />
          <g clipPath={`url(#${idPrefix}clip10)`}>
            <rect width="308" height="20" transform="matrix(0.865865 0.500278 -0.871576 0.490261 28.6738 109.197)" fill="#bfdbfe" />
            
            {/* Icono con flecha y círculo */}
            <circle cx="5" cy="5" r="5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 275.417 256.729)" fill="#60a5fa" />
            <g clipPath={`url(#${idPrefix}clip11)`}>
              <path d="M273.244 260.537L272.903 262.234L279.193 261.893" stroke="#2563EB" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <rect x="-0.00285524" y="0.495269" width="19" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 251.157 245.202)" fill="#bfdbfe" />
            <rect x="-0.00285524" y="0.495269" width="19" height="4" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 251.157 245.202)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="307" height="19" transform="matrix(0.865865 0.500278 -0.871576 0.490261 29.1051 109.451)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 1 */}
          <g clipPath={`url(#${idPrefix}clip12)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.557 103.194)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.971 106.419)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.971 106.419)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 109.988 103.448)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 2 */}
          <g clipPath={`url(#${idPrefix}clip13)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.118 127.207)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.533 130.433)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.533 130.433)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 151.55 127.461)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 3 */}
          <g clipPath={`url(#${idPrefix}clip14)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 192.68 151.22)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.094 154.446)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.094 154.446)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 193.111 151.474)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 4 */}
          <g clipPath={`url(#${idPrefix}clip15)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.241 175.234)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.656 178.459)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.656 178.459)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 234.673 175.488)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 5 */}
          <g clipPath={`url(#${idPrefix}clip16)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 254.885 211.013)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.299 214.239)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.299 214.239)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 255.316 211.267)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 6 */}
          <g clipPath={`url(#${idPrefix}clip17)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.324 187)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.738 190.226)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.738 190.226)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 213.755 187.254)" stroke="#3b82f6" />
          
          {/* Elemento de Lista 7 */}
          <g clipPath={`url(#${idPrefix}clip18)`}>
            <rect width="36" height="12" rx="4" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.201 138.973)" fill="#eff6ff" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.615 142.199)" fill="#60a5fa" />
            <rect x="-0.00285524" y="0.495269" width="5" height="5" rx="1.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.615 142.199)" stroke="#3b82f6" />
          </g>
          <rect x="-0.00285524" y="0.495269" width="35" height="11" rx="3.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 130.632 139.227)" stroke="#3b82f6" />
          
          {/* Líneas de Conexión del Stack */}
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 135.879 123.931)" fill="#3b82f6" />
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 177.441 147.944)" fill="#3b82f6" />
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 219.002 171.958)" fill="#3b82f6" />
          <rect width="12" height="1" transform="matrix(0.865865 0.500278 -0.871576 0.490261 239.646 207.737)" fill="#3b82f6" />
          <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 238.935 189.872)" fill="#3b82f6" />
          <rect width="1" height="12" transform="matrix(0.865865 0.500278 -0.871576 0.490261 155.812 141.845)" fill="#3b82f6" />
        </g>
        
        <rect x="-0.00285524" y="0.495269" width="307" height="94" rx="9.5" transform="matrix(0.865865 0.500278 -0.871576 0.490261 94.4733 72.6817)" stroke="#3b82f6" />
        
        {/* Sombra/Borde Final de la Tarjeta Principal */}
...
/**
 * CAPA BASE (WaveCardLayer)
 * Diseño del componente 2 (Ondas)
 */
 ...
 * Tarjeta genérica gris (Relleno intermedio)
 */
...
export const InteractiveCardStack = ({ className }: { className?: string }) => {
  const idPrefix = useId().replace(/:/g, ''); // Sanitizar ID para selectores CSS

  // Animación de flotación suave personalizada
  ...
  return (
    <div className={cn("relative w-[460px] h-[470px] select-none group mx-auto", className)}>
      ...
      {/* CAPA 4: FONDO (Wave Card) - Se asoma hacia arriba al hacer Hover */}
      <div 
      ...
      {/* CAPA 1: FRENTE (Node Card COMPLETA) - Se desplaza hacia abajo al hacer Hover */}
      <div 
