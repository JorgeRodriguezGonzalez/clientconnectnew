      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4 animate-fade-in">
            ...
            <div className="text-center p-6 rounded-t-2xl glass-card border-2 border-primary shadow-lg shadow-primary/20 hover:scale-[1.02] hover:shadow-xl hover:shadow-primary/40 transition-all duration-300">
