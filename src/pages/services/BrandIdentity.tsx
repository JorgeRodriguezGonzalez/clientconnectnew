...
const processSteps = [
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" /><path d="M12 3v9" /><path d="M12 12h9" />
      </svg>
    ),
...
const brandIdentityFaqs = [
  {
    ...
    answer: "Typically we deliver logo design (primary and secondary lockups), a defined colour palette, typography system, and a brand guidelines document. Depending on scope, we can also include templates, iconography, and visual identity applications for web, social, and print.",
  },
  {
    id: 2,
    question: "How long does brand identity take?",
    answer: "A full brand identity project usually takes 4 to 8 weeks from kick-off to final delivery. Timeline depends on the number of concepts, revision rounds, and how many applications (e.g. social templates, business cards) are included.",
  },
  {
    id: 3,
    question: "How many revision rounds do I get?",
    answer: "We include a set number of revision rounds in the proposal (usually 2–3). This keeps the project on track and ensures feedback is focused. Additional rounds can be added if needed.",
  },
  {
    id: 4,
    question: "What are brand guidelines?",
    answer: "Brand guidelines are a document that explains how to use your logo, colours, fonts, and tone. They include do's and don'ts, spacing rules, and examples so anyone working with your brand keeps it consistent across touchpoints.",
  },
  {
    id: 5,
    question: "Can you help with a rebrand?",
    answer: "Yes. We often work with businesses that are evolving or merging. We can refresh an existing logo, modernise the visual system, or create a completely new identity while respecting what already works for your audience.",
  },
];
                ...
                <Accordion.Header>
                  <Accordion.Trigger className="flex w-full items-start gap-x-4 focus:outline-none group">
                    ...
                    >
                      ...
                      {openItem === item.id.toString() && (
                        <motion.div
                          layoutId="brandidentity-faq-active-line"
          ...
          <div style={{ textAlign: "center", paddingTop: isMobile ? "100px" : "140px", paddingBottom: "16px", position: "relative", zIndex: 2 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  type="email"
                  placeholder="Enter your email for a free brand review"
                  style={{
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "40px 24px 200px", maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              <p style={{
                ...
                Why Your Brand Identity Is Your Most Valuable Business Asset — And Why First Impressions Matter
              </p>
