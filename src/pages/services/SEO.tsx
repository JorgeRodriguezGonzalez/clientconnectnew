...
const processSteps = [
  { step: "Step 1", title: "SEO Audit & Research", description: "We conduct a comprehensive technical audit and deep keyword research to understand your current performance, uncover opportunities, and analyse your competitors' strategies.", badges: ["Technical Audit", "Keyword Research", "Competitor Analysis", "Opportunity Mapping"] },
  { step: "Step 2", title: "On-Page Optimisation", description: "We optimise your website's content, meta tags, headings, internal linking, and site structure to ensure search engines can easily crawl, index, and rank your pages.", badges: ["Meta Tags", "Content Optimisation", "Internal Linking", "Schema Markup"] },
  { step: "Step 3", title: "Content & Link Building", description: "We create high-quality, search-optimised content and earn authoritative backlinks from trusted Australian websites to boost your domain authority and rankings.", badges: ["Blog Content", "Landing Pages", "Backlink Outreach", "Digital PR"] },
  { step: "Step 4", title: "Monitor & Scale", description: "We track your rankings, traffic, and conversions with detailed monthly reporting. Using data-driven insights, we continuously refine and scale your SEO strategy for sustained growth.", badges: ["Rank Tracking", "Monthly Reports", "Strategy Refinement", "Growth Scaling"] },
];
    ...
    <section style={{ background: "#000", padding: "80px 0 0" }}>
      <div style={{ textAlign: "center", marginBottom: "48px", padding: "0 24px" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <h2 style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-1.5px", color: "#fff", marginTop: "12px" }}>Our SEO Process</h2>
          <p style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "15px", fontWeight: 500, color: "rgba(255,255,255,0.5)", maxWidth: "520px", margin: "16px auto 0", lineHeight: 1.65 }}>From audit to growth, we follow a proven 4-step process to deliver SEO results that compound over time and drive sustainable organic traffic.</p>
        </motion.div>
      </div>
...
const seoFaqs = [
  { id: 1, question: "How long does SEO take to work?", answer: "Typically, you'll start seeing initial results within 3 to 4 months, with significant improvements by 6 to 12 months. SEO is a long-term strategy that builds momentum over time — the longer you invest, the stronger and more sustainable your results become." },
  { id: 2, question: "What's included in your SEO service?", answer: "Our comprehensive SEO service includes keyword research, technical SEO audit and fixes, on-page optimisation, content strategy and creation, link building, local SEO (if applicable), and detailed monthly reporting with actionable insights." },
  { id: 3, question: "Do you guarantee rankings?", answer: "We don't guarantee specific rankings as search engines constantly change their algorithms. However, we guarantee our best efforts and a data-driven approach that has consistently delivered results for our clients across a wide range of industries." },
  { id: 4, question: "Will I need to keep paying for SEO?", answer: "SEO is an ongoing process. While results compound over time, you'll need consistent effort to maintain and improve rankings, especially as competitors also optimise their sites. Think of it as an investment that grows — not a one-time expense." },
  { id: 5, question: "How do you measure SEO success?", answer: "We track keyword rankings, organic traffic, click-through rates, conversions, and revenue generated from organic search. You'll receive detailed monthly reports showing exactly how your SEO investment is performing and where opportunities lie." },
];
    ...
    <section className="relative w-full bg-[#050505] py-24 sm:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 max-w-3xl mx-auto text-center mb-16 md:mb-24">
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="text-[16px] md:text-[18px] font-medium leading-relaxed text-zinc-400 tracking-tight">Everything you need to know about our SEO services, timelines, and how we deliver measurable results.</motion.p>
        </div>
                ...
                <Accordion.Header>
                  <Accordion.Trigger className="flex w-full items-start gap-x-4 focus:outline-none group">
                    <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.1, duration: 0.5 }} viewport={{ once: true }}
                      ...
                      {openItem === item.id.toString() && (
                        <motion.div layoutId="seo-faq-active-line" className="absolute left-0 top-0 bottom-0 w-[3px] rounded-l-xl" style={{ backgroundColor: C.green }} />
                      )}
                    </motion.div>
                  </Accordion.Trigger>
                </Accordion.Header>
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: FONT, overflowX: "clip" }}>
      ...
      <SchemaMarkup schema={[
        {
          ...
          "@type": "Service",
          "name": "SEO Services",
          "description": "Expert SEO services in Sydney for tradies and local businesses. Higher rankings, more organic traffic, more leads.",
          "provider": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "SEO Services", "item": "https://clientconnectaustralia.com.au/services/seo" }
          ]
        }
      ]} />
      <Header />
      <main style={{ flex: 1 }}>
          ...
          <div style={{ textAlign: "center", paddingTop: isMobile ? "100px" : "140px", paddingBottom: "16px", position: "relative", zIndex: 2 }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "32px", padding: "0 20px", ...anim(0.5) }}>
              <div style={{
                ...
                <input type="email" placeholder="Enter your email for a free SEO audit" value={heroEmail}
        ...
        <SubServicesSection heading={seoHeading} headingHighlight={seoHighlight} subtitle={seoSubtitle} services={seoServices} />
