...
const ImageCard = ({ item }) => (
  <div style={{
    ...
    overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.3)", background: "#111",
  }}>
...
const processSteps = [
  { step: "Step 1", title: "Discovery & Strategy", description: "We learn about your business, goals, target audience, and competitors. Together we define the sitemap, content strategy, and conversion goals.", IconComp: SearchIcon, badges: ["Business Audit", "Competitor Analysis", "Sitemap", "Content Strategy"] },
  { step: "Step 2", title: "Design & Prototype", description: "We create high-fidelity designs tailored to your brand. You'll see interactive prototypes before any code is written, so we get it right.", IconComp: LayersIcon, badges: ["Wireframes", "UI Design", "Interactive Prototype", "Brand Alignment"] },
  { step: "Step 3", title: "Development & Testing", description: "Clean, fast code built with SEO best practices. We test across all devices and browsers to ensure a flawless experience everywhere.", IconComp: CodeIcon, badges: ["Responsive Code", "SEO Setup", "Speed Optimisation", "Cross-Browser QA"] },
  { step: "Step 4", title: "Launch & Growth", description: "Your new website goes live. We provide training, ongoing support, and performance monitoring to keep driving results.", IconComp: RocketIcon, badges: ["Go Live", "CMS Training", "Analytics Setup", "Ongoing Support"] },
];
    ...
    <section style={{ background: "#000", padding: "80px 0 0" }}>
      <div style={{ textAlign: "center", marginBottom: "48px", padding: "0 24px" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <span style={{ fontFamily: FONT, fontSize: "13px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: C.cyan }}>How We Work</span>
          <h2 style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-1.5px", color: "#fff", marginTop: "12px" }}>Our Process</h2>
          <p style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "15px", fontWeight: 500, color: "rgba(255,255,255,0.5)", maxWidth: "520px", margin: "16px auto 0", lineHeight: 1.65 }}>From discovery to launch, we follow a proven 4-step process to deliver websites that look stunning and drive real business results.</p>
        </motion.div>
      </div>
          ...
          return (
            <div key={i} ref={el => cardRefs.current[i] = el} style={{ position: "sticky", top: `calc(112px + ${i * stackOffset}px)`, marginBottom: `${60 / cardCount}vh`, zIndex: 10 + i }}>
              <div style={{
                ...
                borderRadius: "24px", padding: "52px 48px", position: "relative", overflow: "hidden",
                backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", minHeight: "340px",
                ...
                {isActive && <div style={{ position: "absolute", inset: 0, borderRadius: "24px", padding: "1px", background: C.gradient, WebkitMask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)", WebkitMaskComposite: "xor", maskComposite: "exclude", pointerEvents: "none", opacity: 0.7 }} />}
                ...
                <span style={{
                  ...
                  border: isActive ? `1px solid rgba(${C.secondaryRGB},0.25)` : "1px solid rgba(255,255,255,0.08)",
                  borderRadius: "999px", padding: "5px 14px", transition: "all 0.5s ease",
                  letterSpacing: "0.1em", textTransform: "uppercase",
                }}>{item.step}</span>

                <h3 style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "clamp(28px, 4vw, 40px)", fontWeight: 700, color: "#fff", lineHeight: 1.2, letterSpacing: "-1px", textAlign: "center", margin: 0 }}>{item.title}</h3>

                <p style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "15px", fontWeight: 500, color: isActive ? "rgba(255,255,255,0.65)" : "rgba(255,255,255,0.35)", maxWidth: "560px", lineHeight: 1.7, textAlign: "center", margin: 0, transition: "color 0.5s ease" }}>{item.description}</p>
...
/* ─── FAQ ─── */
const webDesignFaqs = [
  { id: 1, question: "How long does it take to build a website?", answer: "Most projects are completed within 2 to 4 weeks, depending on complexity. A simple landing page or brochure site can be ready in as little as 10 days, while larger e-commerce or multi-page sites may take up to 6 weeks. We'll give you a clear timeline during our initial consultation so there are no surprises." },
  { id: 2, question: "How much does a website cost?", answer: "Our websites start from $2,500 for a professional 5-page site. Pricing depends on the number of pages, custom features, and integrations required. Every project includes custom design, mobile responsiveness, SEO setup, and a content management system. We provide a detailed quote after understanding your specific needs." },
  { id: 3, question: "Will my website be mobile-friendly?", answer: "Absolutely. Every website we build is designed mobile-first, meaning we prioritise the mobile experience from the start. With over 60% of web traffic coming from mobile devices in Australia, this approach ensures your site looks and performs perfectly on phones, tablets, and desktops." },
  { id: 4, question: "Can I update the website content myself?", answer: "Yes. We build all our sites on easy-to-use content management systems so you can update text, images, and pages without any technical knowledge. We also provide a training session after launch and documentation to make sure you feel confident managing your site independently." },
  { id: 5, question: "Do you offer ongoing support after launch?", answer: "We do. We offer flexible maintenance plans that include security updates, performance monitoring, regular backups, and priority support. Whether you need minor content changes or want us to manage the site entirely, we have a plan that fits. Your website is an investment and we help you protect it." },
];

const BackgroundStripes = () => (
  <div className="pointer-events-none absolute inset-0 z-0 h-full w-full opacity-[0.05] invert" style={{ backgroundImage: `url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAGCAYAAADgzO9IAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAZSURBVHgBxcghAQAAAIMw+pf+C+CZHLilebfsBfsvTewEAAAAAElFTkSuQmCC")`, backgroundRepeat: "repeat" }} />
);
    ...
    <section className="relative w-full bg-[#050505] py-24 sm:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 max-w-3xl mx-auto text-center mb-16 md:mb-24">
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="text-[16px] md:text-[18px] font-medium leading-relaxed text-zinc-400 tracking-tight">Everything you need to know about our web design process, pricing, and ongoing support.</motion.p>
        </div>
        <div className="max-w-[800px] mx-auto">
          ...
          <Accordion.Root type="single" collapsible value={openItem || ""} onValueChange={(v) => setOpenItem(v)} className="space-y-4">
              ...
              <Accordion.Item value={item.id.toString()} key={item.id} className="group">
                <Accordion.Header>
                  <Accordion.Trigger className="flex w-full items-start gap-x-4 focus:outline-none group">
                    <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.1, duration: 0.5 }} viewport={{ once: true }} className={cn("relative flex items-center justify-between w-full p-5 text-left transition-all duration-300 border rounded-none", openItem === item.id.toString() ? "bg-[#0a0a0a] border-white/20 shadow-[0_0_20px_rgba(0,0,0,0.5)] z-10" : "bg-white/5 border-white/5 hover:bg-white/10 hover:border-white/10")}>
                      <div className="flex items-center gap-4">
                        <div className={cn("flex items-center justify-center w-8 h-8 rounded-none transition-colors duration-300", openItem === item.id.toString() ? "bg-emerald-500 text-black" : "bg-white/10 text-zinc-500")}><MessageSquare size={14} /></div>
                      ...
                      <span className={cn("ml-4 transition-transform duration-300", openItem === item.id.toString() ? "text-emerald-500 rotate-180" : "text-zinc-600")}>{openItem === item.id.toString() ? <Minus className="h-5 w-5" /> : <Plus className="h-5 w-5" />}</span>
                      {openItem === item.id.toString() && <motion.div layoutId="webdesign-faq-active-line" className="absolute left-0 top-0 bottom-0 w-[3px]" style={{ backgroundColor: C.green }} />}
                    </motion.div>
                  </Accordion.Trigger>
                </Accordion.Header>
      ...
      <main className="flex-1">
        ...
        <section style={{ position: "relative", overflow: "clip", background: "#000", paddingBottom: "80px" }}>
          ...
          <div style={{ textAlign: "center", paddingTop: "140px", paddingBottom: "16px", position: "relative", zIndex: 2 }}>
            <h1 style={{ fontFamily: FONT, fontSize: "clamp(42px, 8vw, 68px)", fontWeight: 600, lineHeight: 1.1, letterSpacing: "-2px", margin: 0, color: "#fff", textTransform: "none", ...anim(0.1) }}>
              Websites That Turn{" "}
